...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>Maharaja Band – Royalty in Every Beat Since 1985</title>
        <meta
          name="description"
          content="Maharaja Band makes Indian weddings majestic with traditional instruments, grand processions, and unforgettable performances since 1985."
        />
        <meta name="keywords" content="Maharaja Band, Indian Wedding Band, Dhol, Royal Wedding, Wedding Procession, Traditional Band India" />
        <meta name="author" content="Maharaja Band" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />

        {/* Open Graph */}
        <meta property="og:title" content="Maharaja Band – Royalty in Every Beat" />
        <meta property="og:description" content="Experience majestic Indian weddings with Maharaja Band — Traditional instruments, decorated baggis, and unforgettable dhol beats." />
        <meta property="og:image" content="/images/home1.jpeg" />
        <meta property="og:url" content="https://yourwebsite.com/" />
        <meta property="og:type" content="website" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Maharaja Band – Royalty in Every Beat" />
        <meta name="twitter:description" content="Experience majestic Indian weddings with Maharaja Band — Traditional instruments, decorated baggis, and unforgettable dhol beats." />
        <meta name="twitter:image" content="/images/home1.jpeg" />
